...
```bash
`r config$remote$prompt` cp file.txt /rdw/03/rse-hpc/training/userid/
`r config$remote$prompt` cd /rdw/03/rse-hpc/training/userid/
...
#### Try out a dry run:
```bash
`r config$remote$prompt` cd /nobackup/proj/training/userid/
...
`r config$remote$prompt` rsync -av TestDir /rdw/03/rse-hpc/training/userid --dry-run
```
```output
...
#### Run ‘for real’:
```bash
`r config$remote$prompt` rsync -av TestDir /rdw/03/rse-hpc/training/userid
```
```output
sending incremental file list
...
```
```bash
`r config$remote$prompt` ls -l /rdw/03/rse-hpc/training/userid/TestDir/
```
```output
total 33
...
```bash
`r config$remote$prompt` rsync -rltv TestDir/ /rdw/03/rse-hpc/training/userid 
```
```output
sending incremental file list
./
...
:::solution
```bash
`r config$remote$prompt` ls -R /rdw/03/rse-hpc/training/userid/
```
```output
/rdw/03/rse-hpc/training/userid/:
